...
from accounts.helper import saveUser, saveProfile
...
class TrainingTeamSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        profile = saveProfile(validated_data.pop('profile'), user.id)
...
class CentralCoordinatorSerializer(CoordinatorSerializer):
    ...
    def create(self, validated_data):
        ...
        return CentralCoordinator.objects.create(**validated_data, user=user,
                                                 profile=profile)
...
class SchoolCoordinatorSerializer(CoordinatorSerializer):
    ...
    def create(self, validated_data):
        user, profile = super().create_coordinator_profile(validated_data)
        return SchoolCoordinator.objects.create(**validated_data, user=user,
                                                profile=profile)
