...
from .models import TrainingTeam
from .serializers import TrainingTeamSerializer
...
class TrainingTeamViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request):
        ...
        try:
            ...
            serializer.save()
            return Response({"training_team": serializer.data, },
    ...
    def update(self, request, pk=None):
        ...
        try:
            ...
            serializer = self.serializer_class(training_team, data=request.data,
                                               partial=True)
            serializer.is_valid(raise_exception=True)
            serializer.save()
            return Response(serializer.data, status=status.HTTP_200_OK)
