...
class OrganisationAdmin(admin.ModelAdmin):
    list_display = ["name_of_association","type","state" ,"date_of_association", "type","updated","is_active"]
    list_filter = ['type','state']
    list_editable = ['is_active']
    search_fields = ["name_of_association"]
    
class SchoolAdmin(admin.ModelAdmin):
    list_display = ["name_of_association","type","organisation","state" ,"date_of_association", "type","updated","is_active"]
    list_filter = ["type",'state']
    list_editable = ['is_active']
...
class PaymentAdmin(admin.ModelAdmin):
    ...
    # list_editable = ['is_active']
    search_fields = ["school__name_of_association","organisation__name_of_association","utr"]
