...
router.register(r'register/organisations', OrganisationViewset,basename='organisation-register')
router.register(r'register/schools', SchoolViewset,basename='school-register')
router.register(r'register/central-coordinators', CentralCoordinatorViewset,basename='central-coord-register')
router.register(r'register/school-coordinators', SchoolCoordinatorViewset,basename='central-coord-register')
